...
public class BaseDB {
    public static void setUpdatedAt(Base object) {
        String tableName = object.getClass().getSimpleName().toLowerCase(); // получаем назавание класса строкой в нижнем регистре
        ...
        try { // пробуем отправить SQL запрос
            ...
            e.printStackTrace();
            System.out.println("Не удалось поменять поле updated_at");
        }
    }
}
